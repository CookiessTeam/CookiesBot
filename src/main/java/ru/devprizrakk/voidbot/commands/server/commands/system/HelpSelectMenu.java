...
import ru.devprizrakk.voidbot.core.command.discord.ICommand;
...
public class HelpSelectMenu extends ListenerAdapter {
    ...
    public HelpSelectMenu(List<ICommand> commands) {
    ...
    private void appendCommandInfo(EmbedBuilder embed,
