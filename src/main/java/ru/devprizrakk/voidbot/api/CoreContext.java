package ru.devprizrakk.voidbot.api;

import net.dv8tion.jda.api.JDA;
import ru.devprizrakk.voidbot.api.command.discord.CommandManager;
...
public final class CoreContext {
    ...
    public ModuleCommandRegistrar getModuleCommandRegistrar() {
        return moduleCommandRegistrar;
    }
