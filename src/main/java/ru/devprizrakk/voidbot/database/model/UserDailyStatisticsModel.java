...
public class UserDailyStatisticsModel {
    ...
    public UserDailyStatisticsModel(Date date, long userId, long messages, long voiceMinutes, long reactions, long commands) {
        this.date = date;
        this.userId = userId;
